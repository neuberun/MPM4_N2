...
class DestinosScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Destino> destinos = [
      Destino(imagem: "images/paris.png", titulo: "Grécia, Europa"),
      Destino(imagem: "images/tokyo.png", titulo: "Dubai, Emirados Árabes"),
      Destino(imagem: "images/ny.png", titulo: "Barramas, Caribe"),
    ];
